...
function VehicleForm({ initialValue, onSubmit, submitLabel, onCancel }) {
  ...
  return <form onSubmit={submit} className="grid gap-3 sm:grid-cols-2">
    ...
    <Field label="Price (INR)" type="number" min="0.01" max="99999999.99" step="0.01" value={form.price} onChange={(value) => update('price', value)} placeholder="1850000.00" />
